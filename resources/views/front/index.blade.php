...
@section('front')
    <section class="main-slider">
        <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,"pagination": {"el": "#main-slider-pagination","type": "bullets","clickable": true},
        "navigation": {"nextEl": "#main-slider__swiper-button-next","prevEl": "#main-slider__swiper-button-prev"},"autoplay": {"delay": 2500}}'>
    ...
    <section class="features py-5">
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 mb-4">
                    <div class="feature-box p-4 shadow-sm">
                        <img src="{{asset('front/images/qualityandtrustworthy.png')}}" alt="Innovative Designs" class="mb-3">
    ...
    <div class="container">
        <div class="home-demo">
            ...
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series1/alu-rosegold.jpg')}}" alt="series 1"></a>

                    <h3>Series 1</h3>
                </div>
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series2/alu-spacegray-nike.jpg')}}" alt="Smartwatch 2"></a>
                    <a href="/">
                        <h3>Series 2</h3>
                    </a>
                </div>
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series3/series3.webp')}}" alt="Smartwatch 3"></a>
                    <a href="/">
                        <h3>Series 3</h3>
                    </a>
                </div>
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series4/series4.webp')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>Series 4</h3>
                    </a>
                </div>
                <div class="item">
                    <a href="/">
                        <img src="{{('front/images/watches/Series5/series_5-spaceblacktitaniumcaseviperdark.png')}}" alt="Smartwatch 5"></a>
                    <a href="/">
                        <h3>Series 5</h3>
                    </a>
                </div>
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series6/series-6-aluminum-blue-case.png')}}" alt="Smartwatch 1"></a>
                    <a href="/">
                        <h3>Series 6</h3>
                    </a>
                </div>
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series7/ii-4.png')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>Series 7</h3>
                    </a>
                </div>
                ...
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series8/qq.webp')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>Series 8</h3>
                    </a>
                </div>
                ...
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/Series10/Apple-Watch-Series-10-42mm.jpg')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>Series 10</h3>
                    </a>
                </div>
                ...
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/WatchSE/cce1-1338-mp_1_.jpg')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>watch SE</h3>
                    </a>
                </div>
                ...
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/WatchSE2/WatchSE44mmstarlight-1200x1200-1.webp')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>watch SE2</h3>
                    </a>
                </div>
                ...
                <div class="item">
                    <a href="/">
                        <img src="{{asset('front/images/watches/WatchUltra/apple-mreh3-watch-ultra-2.jpg.jpeg')}}" alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>watch Ultra</h3>
                    </a>
                </div>
                ...
                <div class="item">
                    <a href="/">
                        <img src="{{('front/images/watches/WatchUltra2/apple-watch-ultra-2-49mm-lte-natural-titanium-natural-milanese-loop-01.webp')}}"
                            alt="Smartwatch 4"></a>
                    <a href="/">
                        <h3>watch Ultra2</h3>
                    </a>
            ...
            <div class="info-content">
                <div class="info-text">
                    ...
                    <div class="info-stats">
                        ...
                        <div class="stat-item">
                            <img src="{{asset('front/images/employee.jpg')}}" alt="">
                            <p>Employees</p>
