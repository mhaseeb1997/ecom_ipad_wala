...
@section('front')
    <div class="social-icons">
        <a href="mailto:officialcodesbunny@gmail.com" target="_blank" className="mail" style="color: black;"><img
                src="images/mail.png" style="width: 30px;" alt=""/> <span>&nbsp;Mail</span></a>
            ...
            @foreach($products as $item)
                <div class="col-lg-4 col-md-4 col=sm=12">
                    <div class="card" style="width: auto; margin: 0 0 30px 0;">
                        <img src="{{asset('front/product/'.$item->thumbnail)}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <a href="{{route('front-product-detail',$item->slug)}}" class="card-link">Product detail</a>
                        </div>
                    </div>
